        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">MERN Store</span>
            </div>
            <p className="text-gray-400 mb-4">
              Your trusted e-commerce platform for premium products with exceptional service and fast delivery.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/deals" className="text-gray-400 hover:text-white transition-colors duration-200">
                  Special Deals
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">support@mernstore.com</span>
              </div>
            </div>
          </div>
        </div>
